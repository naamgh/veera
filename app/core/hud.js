...
(function(){
  ...
  function injectStyles(){
    ...
    style.textContent = `
      ...
      .hud-inline-layout{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;align-items:stretch;width:100%;}
      .hud-inline-item{width:100% !important;min-width:0;min-height:58px;margin:0 !important;padding:6px 10px !important;border-radius:18px !important;display:flex !important;flex-direction:column;align-items:center;justify-content:center;gap:4px;text-align:center;}
      .hud-inline-item .metric-icon{display:none !important;}
      .hud-inline-label{display:flex;align-items:center;justify-content:center;gap:5px;font-size:10px;line-height:1;font-weight:900;letter-spacing:.13em;text-transform:uppercase;color:rgba(100,116,139,.82);white-space:nowrap;}
      body.dark .hud-inline-label{color:rgba(203,213,225,.64);}
      .hud-inline-value{display:flex;align-items:baseline;justify-content:center;gap:4px;font-size:26px;font-weight:950;letter-spacing:-.04em;line-height:1.05;white-space:nowrap;}
      ...
      @media(max-width:760px){.hud-inline-layout{grid-template-columns:repeat(5,minmax(58px,1fr));gap:6px;}.hud-inline-item{min-height:58px;padding:6px 6px !important;border-radius:14px !important;}.hud-inline-label{font-size:8px;letter-spacing:.08em;}.hud-inline-value{font-size:19px;}.hud-inline-value .unit{font-size:9px;}}
    `;
